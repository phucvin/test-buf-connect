...
const (
	...
	ServiceName = "greet.v1.Service"
)

// ServiceClient is a client for the greet.v1.Service service.
type ServiceClient interface {
	Call(context.Context, *connect_go.Request[anypb.Any]) (*connect_go.Response[anypb.Any], error)
}

// NewServiceClient constructs a client for the greet.v1.Service service. By default, it uses the
...
// Call calls greet.v1.Service.Call.
...
// ServiceHandler is an implementation of the greet.v1.Service service.
...
func NewServiceHandler(svc ServiceHandler, opts ...connect_go.HandlerOption) (string, http.Handler) {
	...
	mux.Handle("/greet.v1.Service/Call", connect_go.NewUnaryHandler(
		"/greet.v1.Service/Call",
		svc.Call,
		opts...,
	))
	return "/greet.v1.Service/", mux
}
...
func (UnimplementedServiceHandler) Call(context.Context, *connect_go.Request[anypb.Any]) (*connect_go.Response[anypb.Any], error) {
	return nil, connect_go.NewError(connect_go.CodeUnimplemented, errors.New("greet.v1.Service.Call is not implemented"))
}
